...
int main(int argc, char *argv[])
{
  ...
  /*  double xx=Q2/2./(Einoff*nu+prz*qvec);
    ...
    DeuteronCross test(*elec,"paris",proton,"SLAC",Einoff,36.3274,1.97948,-0.5,8.,1.2,3);
    ...
    cout << costhetar << " " << test.getavgCross(kin,1)/frontdeeps/dxprimedx/Er/HBARC/HBARC/1.E10
     << " " << test.getavgCross(kin,0)/frontdeeps/dxprimedx/Er/HBARC/HBARC/1.E10
     << endl;
    delete elec;
  }
}
