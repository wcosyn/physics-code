 ...
 */
TransGPD_set getTransGPDSet(const double x, const double xi, const double t, const bool ERBL);
...
struct Ftor_doubledistr {
    ...
    void (*f)(numint::vector_d & result, double rho, double x, double xi, double t, GPD_T_Nucl_grid &gpdobject);
      };
 ...
 * @param t [MeV^2] momentum transfer sq.
 */
static void DD_int_rho(numint::vector_d & res, double rho, double x, double xi, double t, GPD_T_Nucl_grid &gpdobject);
