...
struct Ftor_2vector {
  ...
  static void exec(const numint::array<double,2> &x, void *param, numint::vector_d &ret) {
    ...
    p.f(ret,x[0],x[1], p.xi, p.t, p.psq, p.Qsq, p.pGPDService, p.pGPDModel);
  }
  double xi; ///< [] skewness
   ...
   * 
   */
  void (*f)(numint::vector_d &, double u, double z, double xi, double t, double psq, double Qsq, PARTONS::GPDService* pGPDService, PARTONS::GPDModule* pGPDModel);
 ...
 * @param pGPDModel GPD model from PARTONS
 */
static void integrandum_L(numint::vector_d &, double u, double z, double xi, double t, double psq, double Qsq, PARTONS::GPDService* pGPDService, PARTONS::GPDModule* pGPDModel);
 ...
 * @param pGPDModel GPD model from PARTONS
*/
static void integrandum_T(numint::vector_d &, double u, double z, double xi, double t, double psq, double Qsq, PARTONS::GPDService* pGPDService, PARTONS::GPDModule* pGPDModel);
