...
MACRO (ROOT_GENERATE_DICTIONARY_OLD )
   ...
   foreach (_current_FILE ${ARGN})
     ...
     ELSE (${_current_FILE} MATCHES "^.*\\.h$")
       IF (${_current_FILE} MATCHES "^.*\\.cpp$")
         set(OUTFILE ${_current_FILE})
       ELSE (${_current_FILE} MATCHES "^.*\\.cpp$")
         set(INCLUDE_DIRS ${INCLUDE_DIRS} -I${_current_FILE})   
       ENDIF (${_current_FILE} MATCHES "^.*\\.cpp$")
...
#  MESSAGE("INCLUDE_DIRS: ${INCLUDE_DIRS}")
   ...
   STRING(REGEX REPLACE "(^.*).cpp" "\\1.h" bla "${OUTFILE}")
#   MESSAGE("BLA: ${bla}")
...
#  MESSAGE("INCLUDE_DIRS: ${INCLUDE_DIRS}")
  ...
  STRING(REGEX REPLACE "^(.*)\\.(.*)$" "\\1.h" blaa "${OUTFILE}")
#   MESSAGE("BLA: ${blaa}")
  SET (OUTFILES ${OUTFILE} ${blaa})
