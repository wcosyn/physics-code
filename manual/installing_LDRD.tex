...
\subsection{Tagged spectator DIS}
The necessary subroutines for tagged spectator DIS of a deuteron or $^3$He 
...
tested.  More information on these functions can be found in the API (see above 
how to generate it and where to find it).