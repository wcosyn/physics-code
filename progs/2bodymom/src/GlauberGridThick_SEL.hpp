#ifndef GLAUBERGRIDTHICK_SEL_HPP
#define GLAUBERGRIDTHICK_SEL_HPP
 ...
 *
 *  */
class GlauberGridThick_SEL {
	public:
		/** make sure both bpoints and zpoints are always larger than 2 plz **/
		GlauberGridThick_SEL(MeanFieldNucleusThick* nuc,FastParticle& fp,int bpoints, int zpoints);
		~GlauberGridThick_SEL();
...
#endif // GLAUBERGRIDTHICK_SEL_HPP
