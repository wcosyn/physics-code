...
int main(int argc, char *argv[])
{
    ...
    outputFile << "#if more: avg density <rho>[fm^-3] for RMSGA+SRC & plane-wave, the avg radius <r>[fm] for RSMGA & PW and the distorted momentum distribution  rho^D(pm) [fm^3] for RMSGA & PW" << endl;
