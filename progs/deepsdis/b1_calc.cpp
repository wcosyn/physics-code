...
//     double gamma=0.;
  ...
  //     res = numint::cube_romb(mdf,lower,upper,1.E-08,PREC,ret,count,0);
    ...
    //tensor structure functions and coefficients (polarized along electron direction)
      ...
      double b2C= 1./(36*x)*(pow(gamma,2.0)-(6.-9.*pow(gamma,2.0)*eps+2*pow(gamma,4.0))*eps-3.*(6*eps+2*pow(gamma,4.0)*eps+pow(gamma,2.0)*(-1.+5.*eps))*cos(2.*thetaq)+3.*pow(2.,0.5)*pow(gamma,2.0)*(3.+pow(gamma,2.)*pow(eps*(1+eps),0.5)*sin(2.*thetaq)))*b2;
      ...
      double b4C= pow(gamma,2.0)/(12.*x)*(2.*(1.+pow(gamma,2.0))*(eps+3.*eps*cos(2*thetaq)+3.*pow(2.,0.5)*pow(eps*(1+eps),0.5)*cos(thetaq)*sin(thetaq)))*b4;


      double b1C0= 1./3. * (1+pow(gamma,2.0))*(-1.+eps)*(1+3*cos(2*0))*b1;
      double b2C0= 1./(36*x)*(pow(gamma,2.0)-(6.-9.*pow(gamma,2.0)*eps+2*pow(gamma,4.0))*eps-3.*(6*eps+2*pow(gamma,4.0)*eps+pow(gamma,2.0)*(-1.+5.*eps))*cos(2.*0)+3.*pow(2.,0.5)*pow(gamma,2.0)*(3.+pow(gamma,2.)*pow(eps*(1+eps),0.5)*sin(2.*0)))*b2;
      ...
      double b4C0= pow(gamma,2.0)/(12.*x)*(2.*(1.+pow(gamma,2.0))*(eps+3.*eps*cos(2*0)+3.*pow(2.,0.5)*pow(eps*(1+eps),0.5)*cos(0)*sin(0)))*b4;
